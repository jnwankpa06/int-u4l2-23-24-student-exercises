...
submitButton.addEventListener("click", function() {
  ...
  results.innerHTML = "My name is " + myName + ". " + "I'm feeling " + mood + " and I loveeee eating " + food + ". " + "I was born in " + birthYear + " and I am " + age + " years old. " + "I currently live in " + city + "."
